...
2.  Go to the bin folder and clone the repository with the following command ```git clone https://github.com/alejandroGranada/spartacus-training-mentorship.git custom```
