...
import { CmsComponent, CmsComponentChildRoutesConfig, CmsComponentMapping, CmsConfig, ConfigInitializerService, DeferLoadingStrategy } from '@spartacus/core';
...
export declare class CmsComponentsService {
    ...
    private mappings;
    private staticCmsConfig;
    private mappingResolvers;
    constructor(config: CmsConfig, platformId: Object, featureModules?: FeatureModulesService, configInitializer?: ConfigInitializerService);
    /**
