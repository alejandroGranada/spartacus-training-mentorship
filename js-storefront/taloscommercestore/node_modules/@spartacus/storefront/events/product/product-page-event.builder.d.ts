import { EventService, FeatureConfigService, ProductSearchService, ProductService } from '@spartacus/core';
...
export declare class ProductPageEventBuilder {
    ...
    /** @deprecated @since 3.1 - this will be removed in 4.0 */ featureConfigService?: FeatureConfigService);
