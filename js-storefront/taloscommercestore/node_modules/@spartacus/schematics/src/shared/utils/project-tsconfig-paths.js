...
function getTargetTsconfigPath(project, targetName) {
    var _a, _b;
    if (project.targets &&
        project.targets[targetName] && ((_a = project.targets[targetName].options) === null || _a === void 0 ? void 0 : _a.tsConfig)) {
        return core_1.normalize(project.targets[targetName].options.tsConfig);
    }
    if (project.architect &&
        project.architect[targetName] && ((_b = project.architect[targetName].options) === null || _b === void 0 ? void 0 : _b.tsConfig)) {
