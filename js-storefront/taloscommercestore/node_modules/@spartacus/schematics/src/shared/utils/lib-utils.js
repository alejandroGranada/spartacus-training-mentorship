...
exports.packageSubFeaturesMapping = {
    ...
    [constants_1.SPARTACUS_CART]: [constants_1.CLI_CART_SAVED_CART_FEATURE],
...
function addLibraryStyles(stylingConfig, options) {
    return (tree, _context) => {
        ...
        if (tree.exists(libraryScssPath)) {
            let content = (_b = (_a = tree.read(libraryScssPath)) === null || _a === void 0 ? void 0 : _a.toString(constants_1.UTF_8)) !== null && _b !== void 0 ? _b : '';
        ...
        const buildOptions = Object.assign(Object.assign({}, architectBuild === null || architectBuild === void 0 ? void 0 : architectBuild.options), { styles: [
                ...(((_c = architectBuild === null || architectBuild === void 0 ? void 0 : architectBuild.options) === null || _c === void 0 ? void 0 : _c.styles) ? (_d = architectBuild === null || architectBuild === void 0 ? void 0 : architectBuild.options) === null || _d === void 0 ? void 0 : _d.styles : []),
                libraryScssPath,
            ] });
        // `test` architect section
        const architectTest = architect === null || architect === void 0 ? void 0 : architect.test;
        const testOptions = Object.assign(Object.assign({}, architectTest === null || architectTest === void 0 ? void 0 : architectTest.options), { styles: [
                ...(((_e = architectTest === null || architectTest === void 0 ? void 0 : architectTest.options) === null || _e === void 0 ? void 0 : _e.styles) ? (_f = architectTest === null || architectTest === void 0 ? void 0 : architectTest.options) === null || _f === void 0 ? void 0 : _f.styles : []),
                libraryScssPath,
            ] });
        const updatedAngularJson = Object.assign(Object.assign({}, angularJson), { projects: Object.assign(Object.assign({}, angularJson.projects), { [project]: Object.assign(Object.assign({}, angularJson.projects[project]), { architect: Object.assign(Object.assign({}, architect), { build: Object.assign(Object.assign({}, architectBuild), { options: buildOptions }), test: Object.assign(Object.assign({}, architectTest), { options: testOptions }) }) }) }) });
        tree.overwrite(path, JSON.stringify(updatedAngularJson, null, 2));
...
function shouldAddDependency(dependency, packageJson) {
    return (!packageJson ||
        !packageJson[dependency.type].hasOwnProperty(dependency.name));
}
exports.shouldAddDependency = shouldAddDependency;
