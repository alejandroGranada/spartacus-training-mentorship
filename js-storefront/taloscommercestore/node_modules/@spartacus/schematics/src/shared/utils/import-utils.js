...
function isImportedFromSpartacusLibs(node) {
    ...
    for (const def of definitions) {
        ...
        if ((moduleSpecifier === null || moduleSpecifier === void 0 ? void 0 : moduleSpecifier.startsWith(`'${constants_1.SPARTACUS_SCOPE}`)) || (moduleSpecifier === null || moduleSpecifier === void 0 ? void 0 : moduleSpecifier.startsWith(`"${constants_1.SPARTACUS_SCOPE}`))) {
            return true;
        }
    }
    return false;
