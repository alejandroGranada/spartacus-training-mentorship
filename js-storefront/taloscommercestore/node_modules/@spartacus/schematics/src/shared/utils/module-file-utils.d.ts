...
export declare function addToModuleEntryComponents(host: Tree, modulePath: string, entryComponentsText: string, moduleSource?: ts.SourceFile): InsertChange[];
...
export declare function addToMetadata(host: Tree, modulePath: string, text: string, metadataType: 'imports' | 'declarations' | 'entryComponents' | 'exports' | 'providers', moduleSource?: ts.SourceFile): InsertChange[];
