...
exports.ANONYMOUS_CONSENT_TEMPLATES_CONNECTOR_MIGRATION = [
    {
        ...
        comment: `// ${constants_1.TODO_SPARTACUS} Method ${constants_1.LOAD_ANONYMOUS_CONSENTS} changed the return type from 'Observable<AnonymousConsent[] | null>' to 'Observable<AnonymousConsent[]>'`,
    },
];
