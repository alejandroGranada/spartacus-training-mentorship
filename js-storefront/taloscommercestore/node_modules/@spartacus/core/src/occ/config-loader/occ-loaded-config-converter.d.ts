...
export declare class OccLoadedConfigConverter {
    ...
    fromOccBaseSites(baseSites: BaseSite[] | undefined, currentUrl: string): OccLoadedConfig;
    toSiteContextConfig({ baseSite, languages, currencies, urlParameters: urlEncodingAttributes, theme, }: OccLoadedConfig): SiteContextConfig;
