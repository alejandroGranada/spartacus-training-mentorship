...
export declare const getBaseSitesEntities: MemoizedSelector<StateWithSiteContext, BaseSiteEntities>;
export declare const getAllBaseSites: MemoizedSelector<StateWithSiteContext, BaseSite[]>;
