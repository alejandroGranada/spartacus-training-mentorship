...
export declare function getTransferStateReducer(platformId: any, transferState?: TransferState, config?: StateConfig, authStatePersistenceService?: AuthStatePersistenceService): (reducer: any) => any;
