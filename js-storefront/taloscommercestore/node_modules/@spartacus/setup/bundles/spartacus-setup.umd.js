(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@spartacus/storefront'), require('@angular/common/http'), require('@angular/core'), require('@spartacus/core')) :
    typeof define === 'function' && define.amd ? define('@spartacus/setup', ['exports', '@spartacus/storefront', '@angular/common/http', '@angular/core', '@spartacus/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.spartacus = global.spartacus || {}, global.spartacus.setup = {}), global.storefront, global.ng.common.http, global.ng.core, global.core));
}(this, (function (exports, storefront, http, core$1, core) { 'use strict';
            ...
            steps: [
                {
                    ...
                    type: [storefront.CheckoutStepType.PAYMENT_TYPE],
                },
                {
                    id: 'shippingAddress',
                    name: 'checkoutProgress.shippingAddress',
                    routeName: 'checkoutShippingAddress',
                    type: [storefront.CheckoutStepType.SHIPPING_ADDRESS],
                },
                {
                    id: 'deliveryMode',
                    name: 'checkoutProgress.deliveryMode',
                    routeName: 'checkoutDeliveryMode',
                    type: [storefront.CheckoutStepType.DELIVERY_MODE],
                },
                {
                    id: 'paymentDetails',
                    name: 'checkoutProgress.paymentDetails',
                    routeName: 'checkoutPaymentDetails',
                    type: [storefront.CheckoutStepType.PAYMENT_DETAILS],
                },
                {
                    id: 'reviewOrder',
                    name: 'checkoutProgress.reviewOrder',
                    routeName: 'checkoutReviewOrder',
                    type: [storefront.CheckoutStepType.REVIEW_ORDER],
                },
            ],
            express: false,
            defaultDeliveryMode: [storefront.DeliveryModePreferences.FREE],
            guest: false,
        },
    };
    ...
    var B2bStorefrontModule = /** @class */ (function () {
        ...
        B2bStorefrontModule.withConfig = function (config) {
            return {
                ...
                providers: [core.provideConfig(config)],
            };
        };
    ...
    B2bStorefrontModule.decorators = [
        { type: core$1.NgModule, args: [{
                    imports: [
                        ...
                        storefront.CmsLibModule,
                        core.CostCenterModule.forRoot(),
                    ],
                    providers: __spread([
                        core.provideDefaultConfig(storefront.layoutConfig),
                        core.provideDefaultConfig(storefront.mediaConfig),
                        core.provideDefaultConfig(defaultB2bOccConfig),
                        core.provideDefaultConfig(defaultB2bCheckoutConfig)
                    ], storefront.defaultCmsContentProviders),
                    exports: [storefront.StorefrontModule],
                },] }
    ];
